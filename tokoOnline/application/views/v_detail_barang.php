  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-12 col-sm-6">
        ...
        <div class="py-2 px-3 mt-4">
          <h2 class="mb-0">
            <strong>
              ...
              Stok : <?php if ($barang->stok <= 0) {
                        echo '<i class="text-danger">STOK HABIS</i>';
                      } else {
                        echo $barang->stok;
                      }
                      ?>
        ...
        <hr>
        <?php
        echo form_open('belanja/add');   // menangkap Nilai
          ...
          <div class="row">
            ...
            <?php if ($barang->stok <= 0) {
              ...
              echo ' <div class="col-sm-2 mb-2">
                  <input type="number" name="qty" class="form-control" value="1" min="0" max="$barang->stok">
                </div>
                    <div class="col-sm-8">
                    <button type="submit" class="btn btn-primary btn-flat swalDefaultSuccess"><i class="fas fa-cart-plus fa-lg mr-2"></i> 
                      Beli Sekarang
                      </button></div>';
            }
            ?>
...
<!-- AdminLTE for demo purposes Bawaan Template-->
