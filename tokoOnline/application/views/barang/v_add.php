    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <label>Stok</label>
            <input type="number" name="stok" class="form-control" placeholder="Stok Barang" min="0" value="<?= set_value('stok') ?>">
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <label>Bentuk</label>
            <input name="bentuk" class="form-control" placeholder="Bentuk Barang" value="<?= set_value('bentuk') ?>">
          </div>
        </div>
      </div>
