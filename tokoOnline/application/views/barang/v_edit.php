    ...
    <div class="card card-primary">
     ...
     <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
              <label>Stok</label>
              <input name="stok" class="form-control" placeholder="Stok Barang" value="<?= $barang->stok ?>">
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
              <label>Bentuk</label>
              <input name="bentuk" class="form-control" placeholder="Bentuk Barang" value="<?= $barang->bentuk ?>">
          </div>
        </div>
    </div>
