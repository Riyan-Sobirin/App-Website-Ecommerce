<div class="col-md-12">
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Data Barang (Produk)</h3>
        ...
        <tbody>
          ...
          foreach ($barang as $key => $value) { ?>
            <tr>
              ...
              <td class="text-center"><?= $value->bentuk; ?></td>
              <td class="text-center"><img src="<?= base_url('assets/gambar/' . $value->gambar) ?>" alt="" width="200px"></td>
              <?php if ($this->session->userdata('level_user') == 1) { ?>
                <td class="text-center">
                  <a href="<?= base_url('barang/edit/' . $value->id_barang) ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                  <button class="btn btn-danger btn-sm"><i class="fas fa-trash" data-toggle="modal" data-target="#delete<?= $value->id_barang ?>"></i></button>
                </td>
              <?php } ?>
            </tr>
          <?php } ?>
