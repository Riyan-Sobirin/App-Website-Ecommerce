...
<div class="card card-solid">
  <h1 class="text-center btn btn-lg btn-info"> PRODUK TERBARU </h1>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="text-right">
                    <a href="<?= base_url('home/detail_barang/' . $value->id_barang) ?>" <?php if ($value->stok <= 0) {
                                                                                            echo 'class="btn btn-sm btn-danger">STOK HABIS </a>';
                                                                                          } else {
