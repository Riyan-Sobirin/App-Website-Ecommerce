  ...
  <div class="invoice p-3 mb-3">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class="text-center"><?= number_format($berat, 0) ?> Gr</td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
    ...
    $no_order = date('Ymd') . strtoupper(random_string('alnum', 8)); //semua nomor 8 digit 
    ?>
    <div class="row">
      ...
      <div class=" col-4">
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th>Berat:</th>
              <th><?= number_format($tot_berat, 0) ?> Gr</th>
            </tr>
            <tr>
              <th>Ongkir:</th>
