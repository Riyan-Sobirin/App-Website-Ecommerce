            ...
            <tr>
              ...
              <?php if ($this->session->userdata('level_user') == 1) { ?>
                ...
                <td class="text-center">
                  <button class="btn btn-warning btn-sm"><i class="fas fa-edit" data-toggle="modal" data-target="#edit<?= $value->id_kategori ?>"></i></button>
                  <button class="btn btn-danger btn-sm"><i class="fas fa-trash" data-toggle="modal" data-target="#delete<?= $value->id_kategori ?>"></i></button>
                </td>
              <?php } ?>
            </tr>
          <?php } ?>
