 ...
 <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
   <div class="container">
     <a href="<?= base_url() ?>" class="navbar-brand">
       <i><img src="<?= base_url() ?>assets/foto/logo.jpg" width="150px" alt="logo Toko"></i>
     ...
     <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
       ...
       <li class="nav-item">
         <?php if ($this->session->userdata('email') == "") { ?>
           <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
             ...
             <h5 alt="Logo" class="fas fa-user mr-2" style="opacity: .8"></h5>
           </a>
         <?php } else { ?>
           <a class="nav-link" data-toggle="dropdown" href="#">
             <span class="brand-text font-weight-light"><?= $this->session->userdata('nama_pelanggan') ?></span>
             <img src="<?= base_url('assets/foto/foto.png') ?>" alt="foto profile" class="brand-image img-circle elevation-3" style="opacity: .8">
           </a>
       ...
       <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right table-responsive">
           <?php if (empty($keranjang)) { ?>
             ...
             <?php } else {
              ...
              ?>
               ...
               <a href="#" class="dropdown-item">
                 <div class="media">
                   <img src="<?= base_url('assets/gambar/' . $barang->gambar) ?>" alt="User" class="img-size-50 mr-3">
                   <div class="media-body">
                     ...
                     <p class="text-sm text-muted">
                       <i class="fa fa-calculator mr-1"></i> Rp. <?= $this->cart->format_number($value['subtotal']); //Menghitung Subtotal pake bawaan CI3 -Cart 
                                                                  ?>
                     </p>
                   </div>
                 </div>
