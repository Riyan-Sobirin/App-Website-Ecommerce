...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-image mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <i><img src="<?= base_url() ?>assets/foto/logo.jpg" width="90px" alt="" class="brand-image img-circle elevation-3"></i>
        <a href="#" class="brand-text font-weight-light"><?= $this->session->userdata('nama_user') ?></a>
      </div>
    </div>
