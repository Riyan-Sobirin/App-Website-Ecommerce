...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <img src="<?= base_url() ?>assets/foto/logo.jpg" width="200px" alt="Logo My Kitt Store"><br>
      <a href="<?= base_url() ?>"><b>My</b>Kitt Store</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      ...
      <h5><i class="icon fas fa-ban"></i> Alert!</h5>', ' </div>');
        ...
        // Diambil dari controller auth lalu login_user 
