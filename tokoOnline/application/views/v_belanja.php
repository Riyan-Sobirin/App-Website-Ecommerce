    ...
    <div class="table-responsive">
      <div class="row">
        ...
        <div class="col-sm-12">
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url('belanja/delete/' . $items['rowid']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                </td>
              </tr>
          ...
          <!-- <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-shopping-cart"></i> Lanjutkan Belanja</button> -->
          <a href="<?= base_url() ?>" class="btn btn-primary btn-flat"><i class="fa fa-shopping-cart"></i> Lanjutkan Belanja</a>
