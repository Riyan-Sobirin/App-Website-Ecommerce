          ...
          foreach ($user as $key => $value) { ?>
            <tr>
              ...
              <td class="text-center">
                <button class="btn btn-warning btn-sm"><i class="fas fa-edit" data-toggle="modal" data-target="#edit<?= $value->id_user ?>"></i></button>
                <?php if ($value->level_user != 1) { ?>
                  <button class="btn btn-danger btn-sm"><i class="fas fa-trash" data-toggle="modal" data-target="#delete<?= $value->id_user ?>"></i></button>
              </td>
            </tr>
          <?php } ?>
        <?php } ?>
